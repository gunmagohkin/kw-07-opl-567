        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6">
            <div className="flex items-center space-x-2 text-blue-100 text-sm mb-2">
              ...
              <span>{currentEntry.controlNumber}</span>
              <span className="mx-2">•</span>
              ...
              <div className="space-y-4">
                ...
                <div className="relative group">
                  <ImageWithFallback
                    ...
                    className="w-full h-75 object-cover rounded-lg shadow-md group-hover:shadow-lg transition-shadow duration-300"
                  />
          ...
          <div className="bg-gray-50 p-6 flex justify-between items-center">
            ...
            <button
              onClick={handleNext}
              className="flex items-center space-x-2 px-6 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 hover:shadow-md transition-all duration-200 transform hover:scale-105"
            >
              <span>
